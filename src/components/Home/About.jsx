...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Amazing service and results This is the second car I have had full detail with protective coating and the last one still looked amazing after 3 years",
    name: "Simon Gillibrand",
  },
